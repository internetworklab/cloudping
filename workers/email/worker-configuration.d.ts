/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6bb27fb31e0c077a0c79843bd846fd31)
...
declare namespace Cloudflare {
	...
	interface Env {
		EMAIL: SendEmail;
		TUI_SERVICE_TOKEN_ID: SecretsStoreSecret;
		TUI_SERVICE_TOKEN_SECRET: SecretsStoreSecret;
		UPSTREAM_MAIL_API_URL: "https://test-tui.ping2.sh/mail";
		REPLY_SENDER_EMAIL: "cli@ping2.sh";
		REPLY_SENDER_NAME: "Cloudping";
		CLOUDFLARE_ACCOUNT_ID: string;
		CLOUDFLARE_API_TOKEN: string;
		X_CF_SECRET_STORE_ID: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "UPSTREAM_MAIL_API_URL" | "REPLY_SENDER_EMAIL" | "REPLY_SENDER_NAME" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN" | "X_CF_SECRET_STORE_ID">> {}
}

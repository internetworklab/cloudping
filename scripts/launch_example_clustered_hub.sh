...
bin/globalping hub \
  ...
  --peer-ca=https://github.com/internetworklab/globalping/raw/refs/heads/master/confed/jason/ca.pem \
  --peer-ca=https://github.com/internetworklab/globalping/raw/refs/heads/master/confed/moohr/ca.pem \
